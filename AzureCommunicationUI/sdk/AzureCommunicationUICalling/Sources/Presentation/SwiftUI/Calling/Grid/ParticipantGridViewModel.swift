...
class ParticipantGridViewModel: ObservableObject {
  ...
  func update(
    ...
    if callingState.status == .connected {
      ...
      postParticipantsListUpdateAccessibilityAnnouncements(
        removedModels: removedModels,
        addedModels: addedModels)
    }
  ...
  private func getDisplayedInfoViewModels(
    _ infoModels: [ParticipantInfoModel],
    _ dominantSpeakers: [String],
    _ visibilityState: VisibilityState
  ...
  private func getRemovedInfoModels(for newInfoModels: [ParticipantInfoModel])
    -> [ParticipantInfoModel]
  {
  ...
  private func getAddedInfoModels(for newInfoModels: [ParticipantInfoModel])
    -> [ParticipantInfoModel]
  {
  ...
  private func sortDisplayedInfoModels(
    _ newInfoModels: [ParticipantInfoModel],
