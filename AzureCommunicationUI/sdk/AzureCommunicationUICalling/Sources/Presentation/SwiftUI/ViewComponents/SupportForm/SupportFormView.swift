...
internal struct SupportFormView: View {
        ...
        VStack {
          HStack {
            ...
            .accessibilityIdentifier(
              AccessibilityIdentifier.supportFormSubmitAccessibilityId.rawValue
            )
          ...
          HStack {
            ...
            Link(
              viewModel.privacyPolicyText,
              destination: URL(string: StringConstants.privacyPolicyLink)!
            )
            ...
            Spacer()
              ...
              .accessibilityIdentifier(
                AccessibilityIdentifier.supportFormTextFieldAccessibilityId.rawValue)
            #endif
          }
          .padding(.leading, 16)
          .padding(.bottom, 32)
  ...
  func calculatedTextEditorHeight() -> CGFloat {
    let availableHeight =
      screenHeight - landscapeKeyboardWatcher.activeHeight - otherControlsHeightEstimate
