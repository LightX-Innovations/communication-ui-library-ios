...
class AudioDevicesListViewModel: ObservableObject {
  ...
  private func getAvailableAudioDevices(
    audioDeviceStatus: LocalUserState.AudioDeviceSelectionStatus
  )
  ...
  private func getAudioDeviceOption(for audioDeviceType: AudioDeviceType)
    -> SelectableDrawerListItemViewModel
  {
  ...
  private func getAudioDeviceTitle(_ audioDeviceType: AudioDeviceType) -> String {
    ...
    case .bluetooth:
      return audioDeviceType.getBluetoothName()
  ...
  private func isAudioDeviceSelected(
    _ audioDeviceType: AudioDeviceType,
    selectedDevice: LocalUserState.AudioDeviceSelectionStatus
  ) -> Bool {
