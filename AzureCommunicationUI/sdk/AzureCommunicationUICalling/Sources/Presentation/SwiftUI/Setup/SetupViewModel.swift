...
class SetupViewModel: ObservableObject {
  ...
  init(
    ...
    previewAreaViewModel = compositeViewModelFactory.makePreviewAreaViewModel(
  ...
  func updateAccessibilityLabel() {
    if joinCallButtonViewModel.isDisabled {
      ...
      joinCallButtonViewModel.update(
        accessibilityLabel: self.localizationProvider.getLocalizedString(.joinCall))
    }
  }
