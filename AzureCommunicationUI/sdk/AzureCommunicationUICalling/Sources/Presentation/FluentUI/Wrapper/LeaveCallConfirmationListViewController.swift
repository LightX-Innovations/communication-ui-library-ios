...
class LeaveCallConfirmationListViewController: DrawerContainerViewController<
...
>
{
  ...
  private lazy var leaveCallConfirmationTableView: UITableView? = {
    ...
    tableView.register(
      CompositeLeaveCallConfirmationListCell.self,
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    guard indexPath.row < self.items.count,
      let cell = tableView.dequeueReusableCell(
        ...
        for: indexPath) as? CompositeLeaveCallConfirmationListCell
    else {
