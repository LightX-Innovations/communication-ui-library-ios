...
struct CompositeLeaveCallConfirmationList: UIViewControllerRepresentable {
  ...
  > {
    let controller = LeaveCallConfirmationListViewController(
  ...
  func updateUIViewController(
    _ uiViewController: DrawerContainerViewController<DrawerListItemViewModel>,
    context: Context
  ) {
  ...
  static func dismantleUIViewController(
    _ controller: DrawerContainerViewController<DrawerListItemViewModel>,
