...
struct CompositeParticipantsList: UIViewControllerRepresentable {
  ...
  > {
    let controller = ParticipantsListViewController(
  ...
  func updateUIViewController(
    _ uiViewController: DrawerContainerViewController<ParticipantsListCellViewModel>,
    context: Context
  ) {
  ...
  static func dismantleUIViewController(
    _ controller: DrawerContainerViewController<ParticipantsListCellViewModel>,
