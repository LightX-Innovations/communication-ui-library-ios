...
struct CompositeAudioDevicesList: UIViewControllerRepresentable {
  ...
  func makeUIViewController(context: Context) -> DrawerContainerViewController<
    SelectableDrawerListItemViewModel
  > {
    let controller = AudioDevicesListViewController(
  ...
  func updateUIViewController(
    _ uiViewController: DrawerContainerViewController<SelectableDrawerListItemViewModel>,
    context: Context
  ) {
  ...
  static func dismantleUIViewController(
    _ controller: DrawerContainerViewController<SelectableDrawerListItemViewModel>,
