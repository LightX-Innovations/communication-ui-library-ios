...
class ColorThemeProvider {
  ...
  lazy var onSurface: UIColor = {
    return dynamicColor(
      light: Colors.Palette.gray950.color,
  ...
  lazy var warning: UIColor = {
    return dynamicColor(
      light: Colors.Palette.warningTint40.color,
      dark: Colors.warning)
  }()
  ...
  lazy var surface: UIColor = {
    return dynamicColor(
      light: Colors.surfaceQuaternary,
  ...
  init(themeOptions: ThemeOptions?) {
    ...
    self.primaryColorTint10 =
      themeOptions?.primaryColorTint10 ?? Colors.Palette.communicationBlueTint10.color
    self.primaryColorTint20 =
