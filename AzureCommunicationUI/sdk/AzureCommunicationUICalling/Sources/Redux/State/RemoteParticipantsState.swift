...
public struct RemoteParticipantsState {
    ...
    public func toJson() -> [String: Any] {
        ...
        return [
            ...
            "lastUpdateTimeStamp": self.lastUpdateTimeStamp.formatted(Date.ISO8601FormatStyle().dateSeparator(.dash)),
            "dominantSpeakers": dominantSpeakersJson,
            "dominantSpeakersModifiedTimestamp": self.dominantSpeakersModifiedTimestamp.formatted(Date.ISO8601FormatStyle().dateSeparator(.dash)),
...
public struct LobbyError {
    ...
    public func toJson() -> [String: Any] {
        return [
            ...
            "errorTimeStamp": self.errorTimeStamp.formatted(Date.ISO8601FormatStyle().dateSeparator(.dash))
        ]
    }
}
