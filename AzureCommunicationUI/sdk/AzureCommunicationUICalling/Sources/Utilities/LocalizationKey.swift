...
enum LocalizationKey: String {
  ...
  case videoOnAccessibilityLabel =
    "AzureCommunicationUICalling.SetupView.Button.VideoOn.AccessibilityLabel"
  case micOff = "AzureCommunicationUICalling.SetupView.Button.MicOff"
  case micOffAccessibilityLabel =
    "AzureCommunicationUICalling.SetupView.Button.MicOff.AccessibilityLabel"
  case micOn = "AzureCommunicationUICalling.SetupView.Button.MicOn"
  case micOnAccessibilityLabel =
    "AzureCommunicationUICalling.SetupView.Button.MicOn.AccessibilityLabel"
  case device = "AzureCommunicationUICalling.SetupView.Button.Device"
  case deviceAccesibiiltyLabel =
  ...
  case resumeAccessibilityLabel =
    "AzureCommunicationUICalling.OnHoldView.Button.Resume.AccessibilityLabel"
  ...
  case lobbyWaitingToJoin =
    "AzureCommunicationUICalling.CallingView.LobbyWaitingHeader.LobbyWaitingToJoin"
  ...
  case lobbyActionUnknownError =
    "AzureCommunicationUICalling.CallingView.LobbyActionError.UnknownError"

  case lobbyActionErrorDismiss =
    "AzureCommunicationUICalling.CallingView.LobbyActionError.Dismiss.AccessibilityLabel"
  ...
  case participantListWaitingInLobby =
    "AzureCommunicationUICalling.CallingView.ParticipantDrawer.WaitingInLobby"
  case participantListInTheCall =
    "AzureCommunicationUICalling.CallingView.ParticipantDrawer.InTheCall"
  case participantListAdmitAll =
    "AzureCommunicationUICalling.CallingView.ParticipantDrawer.AdmitAll"
  ...
  case participantListConfirmAdmit =
  ...
  case leaveCallListHeader =
    "AzureCommunicationUICalling.CallingView.LeaveCallList.Header.LeaveCall"
  ...
  case bannerBodyTranscriptionStopped =
    "AzureCommunicationUICalling.CallingView.BannerBody.TranscriptionStopped"
  case bannerBodyOnlyTranscribing =
    "AzureCommunicationUICalling.CallingView.BannerBody.OnlyTranscribing"
  case bannerBodyRecordingStopped =
    "AzureCommunicationUICalling.CallingView.BannerBody.RecordingStopped"
  ...
  case bannerDisplayLinkPrivacyPolicy =
    "AzureCommunicationUICalling.CallingView.BannerLink.PrivacyPolicy"
  ...
  case snackBarDismissAccessibilityLabel =
    "AzureCommunicationUICalling.SnackBar.Button.Dismiss.AccessibilityLabel"
  case snackBarDismissAccessibilityHint =
    "AzureCommunicationUICalling.SnackBar.Button.Dismiss.AccessibilityHint"
  ...
  case snackBarErrorOnHoldSubtitle =
    "AzureCommunicationUICalling.SnackBar.Text.ErrorResumeCallSubTitle"
  ...
  case callDiagnosticsNetworkQualityLow =
    "AzureCommunicationUICalling.Diagnostics.Text.NetworkQualityLow"
  case callDiagnosticsNetworkLost = "AzureCommunicationUICalling.Diagnostics.Text.NetworkLost"
  case callDiagnosticsNetworkReconnect =
    "AzureCommunicationUICalling.Diagnostics.Text.NetworkReconnect"
  case callDiagnosticsCameraNotWorking =
    "AzureCommunicationUICalling.Diagnostics.Text.CameraNotStarted"
  case callDiagnosticsUnableToLocateSpeaker =
    "AzureCommunicationUICalling.Diagnostics.Text.UnableToLocateSpeaker"
  case callDiagnosticsUnableToLocateMicrophone =
    "AzureCommunicationUICalling.Diagnostics.Text.UnableToLocateMicrophone"
  case callDiagnosticsMicrophoneNotWorking =
    "AzureCommunicationUICalling.Diagnostics.Text.MicrophoneNotWorking"
  case callDiagnosticsSpeakerNotWorking =
    "AzureCommunicationUICalling.Diagnostics.Text.SpeakerNotWorking"
  ...
  case supportFormDescribeYourIssueHintText =
    "AzureCommunicationUICalling.DescribeYourIssueHint.Text"
