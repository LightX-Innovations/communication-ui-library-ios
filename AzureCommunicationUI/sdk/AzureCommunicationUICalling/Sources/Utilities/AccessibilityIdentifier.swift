...
enum AccessibilityIdentifier: String {
  ...
  case joinCallAccessibilityID =
    "AzureCommunicationUICalling.SetupView.Button.JoinCall.AccessibilityID"
  case toggleVideoAccessibilityID =
    "AzureCommunicationUICalling.SetupView.Button.Video.AccessibilityID"
  case toggleMicAccessibilityID = "AzureCommunicationUICalling.SetupView.Button.Mic.AccessibilityID"
  case toggleAudioDeviceAccessibilityID =
    "AzureCommunicationUICalling.SetupView.Button.AudioDevice.AccessibilityID"
  case dismissButtonAccessibilityID =
    "AzureCommunicationUICalling.SetupView.Button.Dismiss.AccessibilityID"
  case goToSettingsAccessibilityID =
    "AzureCommunicationUICalling.SetupView.Button.GoToSettings.AccessibilityID"
  case videoAccessibilityID =
    "AzureCommunicationUICalling.CallingView.ControlButton.Video.AccessibilityID"
  case micAccessibilityID =
    "AzureCommunicationUICalling.CallingView.ControlButton.Microphone.AccessibilityID"
  case audioDeviceAccessibilityID =
    "AzureCommunicationUICalling.CallingView.ControlButton.AudioDevice.AccessibilityID"
  case hangupAccessibilityID =
    "AzureCommunicationUICalling.CallingView.ControlButton.HangUp.AccessibilityID"
  case cancelAccessibilityID =
    "AzureCommunicationUICalling.CallingView.Overlay.Cancel.AccessibilityID"
  case moreAccessibilityID =
    "AzureCommunicationUICalling.CallingView.ControlButton.More.AccessibilityID"
