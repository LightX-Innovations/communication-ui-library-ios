...
public class CallComposite {
  ...
  private lazy var callHistoryRepository = CallHistoryRepository(
    logger: logger,
  ...
  private func constructViewFactoryAndDependencies(
    ...
    self.callHistoryService = CallHistoryService(
      store: store, callHistoryRepository: self.callHistoryRepository)
  ...
  private func createDebugInfoManager(callingSDKWrapper: CallingSDKWrapperProtocol)
    -> DebugInfoManagerProtocol
  {
  ...
  private func present(_ viewController: UIViewController) {
    ...
    Task { @MainActor in
      guard self.isCompositePresentable(),
        let topViewController = UIWindow.keyWindow?.topViewController
      else {
