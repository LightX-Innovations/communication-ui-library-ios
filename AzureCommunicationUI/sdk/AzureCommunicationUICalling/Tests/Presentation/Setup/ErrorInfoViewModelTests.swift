...
class ErrorInfoViewModelTests: XCTestCase {
  ...
  func
    test_errorInfoViewModel_update_when_errorStateCallJoinSet_then_snackBarErrorJoinCallMessageDisplayed()
  {
    let sut = makeSUT()
  ...
  func
    test_errorInfoViewModel_update_when_errorStateCallEvictionSet_then_snackBarErrorCallEvictedMessageDisplayed()
  {
    let sut = makeSUT()
    let state = ErrorState(
  ...
  func
    test_errorInfoViewModel_update_when_errorStateCallDeniedSet_then_snackBarErrorCallDeniedMessageDisplayed()
  {
    let sut = makeSUT()
    let state = ErrorState(
  ...
  func
    test_errorInfoViewModel_update_when_errorStateCameraOnFailedSet_then_snackBarErrorCameraOnFailedMessageDisplayed()
  {
    let sut = makeSUT()
    let state = ErrorState(
      internalError: .cameraOnFailed,
      error: nil,
      errorCategory: .callState)
  ...
  func
    test_errorInfoViewModel_update_when_errorStateConnectionFailed_then_snackBarErrorConnectionErrorDisplayed()
  {
    let sut = makeSUT()
    let state = ErrorState(
