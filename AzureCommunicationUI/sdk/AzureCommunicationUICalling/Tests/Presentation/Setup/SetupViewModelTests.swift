...
class SetupViewModelTests: XCTestCase {
  ...
  func
    test_setupViewModel_when_joinCallButtonTapped_then_shouldCallStartRequest_isJoinRequestedTrue()
  {
  ...
  func test_setupViewModel_receive_when_appStateUpdated_then_reviewAreaViewModelUpdated() {
    ...
    let updatePreviewAreaViewModel: ((LocalUserState, PermissionState, VisibilityState) -> Void) = {
      userState, permissionsState, _ in
