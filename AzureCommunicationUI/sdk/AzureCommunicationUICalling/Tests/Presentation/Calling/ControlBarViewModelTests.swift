...
class ControlBarViewModelTests: XCTestCase {
  ...
  func
    test_controlBarViewModel_dismissConfirmLeaveOverlay_when_isConfirmLeaveListDisplayedTrue_shouldBecomeFalse()
  {
    let sut = makeSUT()
  ...
  func
    test_controlBarViewModel_microphoneButtonTapped_when_micStatusOff_then_shouldMicrophoneOnRequested()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    sut.audioState = LocalUserState.AudioState(
      operation: .off,
  ...
  func
    test_controlBarViewModel_microphoneButtonTapped_when_micStatusOn_then_shouldMicrophoneOffRequested()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    sut.audioState = LocalUserState.AudioState(
  ...
  func
    test_controlBarViewModel_update_when_micStatusOffAndUpdateWithMicOff_then_shouldNotBePublished()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
  ...
  func
    test_controlBarViewModel_update_when_micStatusOnAndUpdateWithMicOon_then_shouldNotBePublished()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    expectation.isInverted = true
  ...
  // MARK: Camera tests
  func
    test_controlBarViewModel_cameraButtonTapped_when_cameraStatusOff_then_shouldRequestCameraOnTriggered()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    storeFactory.store.$state
    ...
    sut.cameraState = LocalUserState.CameraState(
      operation: .off,
      device: .front,
      transmission: .local)
  ...
  func
    test_controlBarViewModel_cameraButtonTapped_when_cameraStatusOn_then_shouldRequestCameraOffTriggered()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    storeFactory.store.$state
  ...
  func
    test_controlBarViewModel_when_selectAudioDeviceButtonTapped_then_audioDeviceSelectionDisplayed()
  {
    let sut = makeSUT()
  ...
  func
    test_controlBarViewModel_update_when_cameraStatusOffAndUpdateWithCameraOff_then_shouldNotBePublished()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    expectation.isInverted = true
  ...
  func
    test_controlBarViewModel_update_when_cameraStatusOffAndUpdateWithCameraOn_then_shouldBePublished()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    sut.cameraButtonViewModel.$iconName
  ...
  func
    test_controlBarViewModel_update_when_cameraStatusOnAndUpdateWithCameraOn_then_shouldNotBePublished()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    expectation.isInverted = true
  ...
  func
    test_controlBarViewModel_update_when_cameraStatusOnAndUpdateWithCameraOff_then_shouldBePublished()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    sut.cameraButtonViewModel.$iconName
  ...
  func
    test_controlBarViewModel_update_when_statesUpdated_then_cameraButtonViewModelDisabledStateUpdated()
  {
    let expectation = XCTestExpectation(
      description: "Camera button disabled state should be updated")
    expectation.assertForOverFulfill = true
    factoryMocking.createIconButtonViewModel = { icon in
      guard icon == .videoOff
      else { return nil }
  ...
  func
    test_controlBarViewModel_update_when_statesUpdated_then_micButtonViewModelDisabledStateUpdated()
  {
  ...
  func
    test_controlBarViewModel_update_when_statesUpdated_then_audioDeviceButtonViewModelIconUpdated()
  {
    let expectation = XCTestExpectation(description: "Mic button disabled state should be updated")
    expectation.assertForOverFulfill = true
    factoryMocking.createIconButtonViewModel = { icon in
