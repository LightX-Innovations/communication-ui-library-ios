...
class ParticipantCellViewModelTests: XCTestCase {
  ...
  func
    test_participantCellViewModel_update_when_hasScreenShareVideoStream_then_updateScreenShareVideoStream()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "subscription exception")
  ...
  func
    test_participantCellViewModel_update_when_hasBothCameraAndScreenShareVideoStream_then_updateScreenShareVideoStream()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "subscription exception")
    let expectedVideoStream = "screenShare"
  ...
  func
    test_participantCellViewModel_update_when_hasNoScreenShareVideoStream_then_updateCameraVideoStream()
  {
    let sut = makeSUT()
    let expectation = XCTestExpectation(description: "subscription exception")
