...
class PermissionReducerTests: XCTestCase {
  ...
  func
    test_permissionReducer_reduce_when_audioPermissionRequest_shouldReturnAudioPermissionRequesting()
  {
    let state = PermissionState()
  ...
  func
    test_permissionReducer_reduce_when_audioPermissionNotAsked_shouldReturnAudioPermissionNotAsked()
  {
    let state = PermissionState()
  ...
  func
    test_permissionReducer_reduce_when_cameraPermissionRequest_shouldReturnCameraPermissionRequesting()
  {
    let state = PermissionState()
  ...
  func
    test_permissionReducer_reduce_when_cameraPermissionNotAsked_shouldReturnCameraPermissionNotAsked()
  {
    let state = PermissionState()
