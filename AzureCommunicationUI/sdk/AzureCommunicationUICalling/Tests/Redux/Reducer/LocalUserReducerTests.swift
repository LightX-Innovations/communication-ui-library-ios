...
class LocalUserReducerTests: XCTestCase {
  ...
  func
    test_localUserReducer_reduce_when_localUserActionUpdateMicStateUpdated_then_localUserUnMuted()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionMicrophoneOnRequested_then_micStatusSwitching()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionMicrophoneOffRequested_then_micStatusSwitching()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionCameraSwitchTriggered_then_cameraDeviceStatusIsSwitching()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionCameraSwitchSuccessToBack_then_cameraDeviceStatusIsBack()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionCameraSwitchFail_then_cameraDeviceStatusIsError()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionAudioDeviceChangeRequested_then_audioDeviceStatusIsSpeakerRequested()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserAudioDeviceChangeRequested_then_audioDeviceStatusIsReceiverRequested()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionAudioDeviceChangeSucceeded_then_audioDeviceStatusIsSpeakerSelected()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionAudioDeviceChangeSucceeded_then_audioDeviceStatusIsReceiverSelected()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionAudioDeviceChangeFailed_then_audioDeviceStatusIsError()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionCameraPreviewOnTriggered_then_cameraTransmissionStatusIsLocal_cameraStatusIsPending()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionCameraOnTriggered_then_cameraTransmissionStatusIsRemote_cameraStatusIsPending()
  {
    let state = LocalUserState()
  ...
  func
    test_localUserReducer_reduce_when_localUserActionCameraOffTriggered_then_cameraStatusIsPending()
  {
    let state = LocalUserState()
    let expectedCameraStatus = LocalUserState.CameraOperationalStatus.pending
  ...
  func
    test_localUserReducer_reduce_when_localUserActionCameraPausedSucceeded_then_cameraStatusIsPaused()
  {
    let state = LocalUserState()
