...
class CompositeErrorManagerTests: XCTestCase {
  ...
  override func setUp() {
    ...
    compositeManager = CompositeErrorManager(
  ...
  func
    test_errorManager_receiveState_when_noFatalError_callNotExisted_then_nodidFailEventCalled_hostingVCDismissCalled()
  {
    handlerCallExpectation.isInverted = true
