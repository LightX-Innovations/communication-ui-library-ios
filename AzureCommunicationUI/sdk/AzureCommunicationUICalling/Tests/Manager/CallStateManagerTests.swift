...
class CompositeStateManagerTests: XCTestCase {
  ...
  func
    test_callStateManager_when_reduxStateChangedToConnected_then_stateEventHandlerCalledWithConnectedState()
  {
  ...
  func
    test_callStateManager_when_reduxStateChangedToConnecting_then_stateEventHandlerCalledWithConnectingState()
  {
  ...
  func
    test_callStateManager_when_reduxStateChangedToDisconnecting_then_stateEventHandlerCalledWithDisconnectingState()
  {
  ...
  func
    test_callStateManager_when_reduxStateChangedToDisconnected_then_stateEventHandlerCalledWithDisconnectedState()
  {
  ...
  func
    test_callStateManager_when_reduxStateChangedToEarlyMedia_then_stateEventHandlerCalledWithEarlyMediaState()
  {
  ...
  func
    test_callStateManager_when_reduxStateChangedToInLobby_then_stateEventHandlerCalledWithInLobbyState()
  {
  ...
  func
    test_callStateManager_when_reduxStateChangedToLocalHold_then_stateEventHandlerCalledWithLocalHoldState()
  {
  ...
  func
    test_callStateManager_when_reduxStateChangedToRemoteHold_then_stateEventHandlerCalledWithRemoteHoldState()
  {
