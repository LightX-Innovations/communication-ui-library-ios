...
class AccessibilityProviderMocking: AccessibilityProviderProtocol {
  ...
  var subscribeToVoiceOverStatusDidChangeNotificationBlock:
    ((AccessibilityProviderNotificationsObserver) -> Void)?
  var subscribeToUIFocusDidUpdateNotificationBlock:
    ((AccessibilityProviderNotificationsObserver) -> Void)?
  ...
  func subscribeToVoiceOverStatusDidChangeNotification(
