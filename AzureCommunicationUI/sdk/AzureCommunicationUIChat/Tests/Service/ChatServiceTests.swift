...
class ChatServiceTests: XCTestCase {
  ...
  func
    test_chatService_getMaskedParticipantIds_shouldCallChatSDKWrapperGetListOfParticipantsCalled()
    async throws
  {
  ...
  func test_chatService_getListOfParticipants_shouldCallChatSDKWrapperGetListOfParticipantsCalled()
    async throws
  {
  ...
  func test_chatService_getPreviousMessages_shouldCallchatSDKWrapperGetPreviousMessages()
    async throws
  {
  ...
  func test_chatService_sendTypingIndicator_shouldCallchatSDKWrapperSendTypingIndicator()
    async throws
  {
