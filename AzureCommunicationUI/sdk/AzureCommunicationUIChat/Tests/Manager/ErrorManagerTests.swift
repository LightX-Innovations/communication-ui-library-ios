...
class ErrorManagerTests: XCTestCase {
  ...
  func
    test_errorManager_receiveState_when_noFatalError_navigationExit_then_noDidFailEventCalled_hostingVCDismissCalled()
  {
  ...
  func
    test_errorManager_receiveState_when_noFatalError_chatNotExisted_then_nodidFailEventCalled_hostingVCDismissCalled()
  {
    handlerChatExpectation.isInverted = true
  ...
  func test_errorManager_receiveState_when_nonFatalErrorSendMessage_then_receiveDidFail() {
    let nonFatalError = ChatCompositeError(
      code: ChatCompositeErrorCode.sendMessageFailed, error: nil)
    self.expectedError = nonFatalError
    let errorState = ErrorState(
      internalError: .messageSendFailed,
      error: nil,
