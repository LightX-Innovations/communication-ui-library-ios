...
class MessageRepositoryManagerTests: XCTestCase {
  ...
  func
    test_messageRepositoryManager_addInitialMessages_with_zeroInitialMessages_then_messagesCountWillBeZero()
  {
    let sut = makeSUT()
  ...
  func
    test_messageRepositoryManager_addInitialMessages_with_nonEmptyInitialMessages_then_messagesCountWillBeSame()
  {
    let sut = makeSUT()
    let initialMessages = [
  ...
  func
    test_messageRepositoryManager_addPreviousMessages_with_nonEmptyPreviousMessages_then_messagesCountWillBeMatching()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
    ...
    XCTAssertEqual(
      sut.messages.count,
      initialMessages.count + previousMessages1.count)
    sut.addPreviousMessages(previousMessages: previousMessages2)
    XCTAssertEqual(
      sut.messages.count,
      initialMessages.count + previousMessages1.count + previousMessages2.count)
  }

  func
    test_messageRepositoryManager_addPreviousMessages_with_previousMessagesContainExistingMessage_then_messagesCountWillBeIgnoreExistingMessages()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
    ...
    XCTAssertEqual(
      sut.messages.count,
      initialMessages.count + previousMessages1.count - duplicateCount)
  }

  func
    test_messageRepositoryManager_addPreviousMessages_with_messagesBeforeInitialFetchTimestamp_then_messagesCountWillBeMatching()
  {
    ...
    let previousMessages1 = [
      ...
      ChatMessageInfoModel(
        type: .participantsAdded, createdOn: Iso8601Date(initialFetchTimestamp.value - 2)),
    ]
  ...
  func
    test_messageRepositoryManager_addPreviousMessages_with_messagesAfterInitialFetchTimestamp_then_messagesCountWillBeIgnoreSystemMessages()
  {
    ...
    sut.addPreviousMessages(previousMessages: previousMessages1)
    XCTAssertEqual(
      initialMessages.count + previousMessages1.count - systemMessagesAfterCount,
      expectedMessageCount)
  }

  func
    test_messageRepositoryManager_addNewSentMessage_when_nonEmptyInitialMessages_then_messagesCountWillBeIncrementByOne()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_addNewSentMessage_when_zeroInitialMessages_then_messagesCountWillBeIncrementByOne()
  {
    let sut = makeSUT()
    let message = ChatMessageInfoModel()
    sut.addNewSendingMessage(message: message)
  ...
  func
    test_messageRepositoryManager_editMessage_when_foundMatchingMessageId_then_contentAndTimestampWillBeUpdated()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_deleteMessage_when_foundMatchingMessageId_then_deletedOnWillBeNotNil()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_replaceMessageId_when_foundMatchingInternalId_then_actualIdWillBeUpdated()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_replaceMessageId_when_notFoundMatchingInternalId_then_messagesNotChanged()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_updateEditMessageTimestamp_when_foundMatchingMessageId_then_editedOnWillBeNotNil()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_updateDeletedMessageTimestamp_when_foundMatchingMessageId_then_editedOnWillBeNotNil()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func test_messageRepositoryManager_addTopicUpdatedMessage_then_messagesCountWillBeIncrementByOne()
  {
    ...
    let topic = "newTopic"
    let sut = makeSUT(messages: initialMessages)
    let threadInfo = ChatThreadInfoModel(
      topic: topic,
  ...
  func
    test_messageRepositoryManager_addReceivedMessage_when_zeroInitialMessages_then_messagesCountWillBeIncrementByOne()
  {
    let sut = makeSUT()
    let message = ChatMessageInfoModel()
  ...
  func
    test_messageRepositoryManager_addReceivedMessage_when_nonEmptyInitialMessages_then_messagesCountWillBeIncrementByOne()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_addReceivedMessage_when_localUserMessage_then_messagesCountWillNotBeIncremented()
  {
    let sut = makeSUT()
  ...
  func
    test_messageRepositoryManager_updateMessageEdited_when_foundMatchingInternalId_then_messageEditedOnNotNil()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_updateMessageEdited_when_notFoundMatchingInternalId_then_messageEditedOnIsNil()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_updateMessageDeleted_when_foundMatchingInternalId_then_messageDeletedOnNotNil()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_updateMessageDeleted_when_notFoundMatchingInternalId_then_messageDeletedOnIsNil()
  {
    let initialMessages = [
      ChatMessageInfoModel(),
      ChatMessageInfoModel(),
  ...
  func
    test_messageRepositoryManager_updateMessageReadReceiptStatus_when_everyParticipantHasReadMessage_then_sendStatusWillBeUpdated()
  {
    ...
    let readReceiptInfo = ReadReceiptInfoModel(
      senderIdentifier: CommunicationUserIdentifier("identifier"), chatMessageId: lastMessageId,
      readOn: Iso8601Date())
    ...
    sut.updateMessageReadReceiptStatus(
      readReceiptInfo: readReceiptInfo, state: getAppState(participantsState: participantsState))
  ...
  func
    test_messageRepositoryManager_updateMessageReadReceiptStatus_when_someParticipantsHaveReadMessage_then_sendStatusWillNotBeUpdated()
  {
    let lastMessageId = "1668456344995"
    let initialMessages = [
      ChatMessageInfoModel(id: "1668436344995"),
  ...
  func
    test_messageRepositoryManager_addLocalUserRemovedMessage_when_initialMessages_then_messagesCountWillBeIncrementByOne()
  {
    let sut = makeSUT()
  ...
  func
    test_messageRepositoryManager_updateMessageSendStatus_when_foundMatchingMessageId_then_messageSendStatusWillBeUpdated()
  {
    let initialMessages = [
  ...
  func
    test_messageRepositoryManager_updateMessageSendStatus_when_notFoundMatchingMessageId_then_messageDeletedOnIsNil()
  {
    let initialMessages = [
      ChatMessageInfoModel(id: "id1"),
      ChatMessageInfoModel(id: "id2"),
