...
class RepositoryMiddlewareTests: XCTestCase {
  ...
  func
    test_repositoryMiddleware_apply_when_fetchInitialMessagesSuccessRepositoryAction_then_handlerAddTopicUpdatedMessageCalledBeingCalled()
  {
  ...
  func
    test_repositoryMiddleware_apply_when_participantsAddedParticipantsAction_then_handlerParticipantAddedMessageBeingCalled()
  {
    ...
    let participants = [
      ParticipantInfoModel(
        identifier: CommunicationUserIdentifier("id1"),
        displayName: "displayName1"),
      ParticipantInfoModel(
        identifier: CommunicationUserIdentifier("id2"),
        displayName: "displayName2"),
    ]
    middlewareDispatch(getEmptyDispatch())(
      .participantsAction(.participantsAdded(participants: participants)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_repositoryMiddleware_apply_when_participantsRemovedParticipantsAction_then_handlerParticipantRemovedMessageBeingCalled()
  {
    ...
    middlewareDispatch(getEmptyDispatch())(
      .participantsAction(.participantsRemoved(participants: participants)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_repositoryMiddleware_apply_when_fetchInitialMessagesSuccessRepositoryAction_then_handlerLoadInitialMessagesCalledBeingCalled()
  {
    ...
    middlewareDispatch(getEmptyDispatch())(
      .repositoryAction(.fetchInitialMessagesSuccess(messages: messages)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_repositoryMiddleware_apply_when_fetchPreviousMessagesSuccessRepositoryAction_then_handlerAddPreviousCalledMessagesCalled()
  {
    ...
    let messages: [ChatMessageInfoModel] = []
    middlewareDispatch(getEmptyDispatch())(
      .repositoryAction(.fetchPreviousMessagesSuccess(messages: messages)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_repositoryMiddleware_apply_when_sendMessageTriggeredRepositoryAction_then_handlerLoadInitialMessagesCalledBeingCalled()
  {
  ...
  func
    test_repositoryMiddleware_apply_when_editMessageTriggeredRepositoryAction_then_handlerUpdateNewEditedMessageBeingCalled()
  {
  ...
  func
    test_repositoryMiddleware_apply_when_deleteMessageTriggeredRepositoryAction_then_handlerUpdateNewDeletedMessageBeingCalled()
  {
  ...
  func
    test_repositoryMiddleware_apply_when_sendMessageSuccessRepositoryAction_then_handlerLoadInitialMessagesCalledBeingCalled()
  {
  ...
  func
    test_repositoryMiddleware_apply_when_editMessageTriggeredRepositoryAction_then_handlerUpdateEditedMessageTimestampBeingCalled()
  {
  ...
  func
    test_repositoryMiddleware_apply_when_editMessageTriggeredRepositoryAction_then_handlerUpdateDeletedMessageTimestampBeingCalled()
  {
  ...
  func
    test_repositoryMiddleware_apply_when_chatMessageReceivedRepositoryAction_then_handlerAddReceivedMessageBeingCalled()
  {
    ...
    middlewareDispatch(getEmptyDispatch())(
      .repositoryAction(.chatMessageReceived(message: message)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_repositoryMiddleware_apply_when_chatMessageEditedReceivedRepositoryAction_then_handlerUpdateReceivedEditedMessageBeingCalled()
  {
    ...
    let message = ChatMessageInfoModel()
    middlewareDispatch(getEmptyDispatch())(
      .repositoryAction(.chatMessageEditedReceived(message: message)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_repositoryMiddleware_apply_when_chatMessageDeletedReceivedRepositoryAction_then_handlerUpdateReceivedDeletedMessageCalled()
  {
    ...
    let message = ChatMessageInfoModel()
    middlewareDispatch(getEmptyDispatch())(
      .repositoryAction(.chatMessageDeletedReceived(message: message)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_repositoryMiddleware_apply_when_readReceiptReceivedParticipantsAction_then_handlerUpdateMessageReadReceiptStatusCalledBeingCalled()
  {
    ...
    let readReceiptInfo = ReadReceiptInfoModel(
      ...
      readOn: Iso8601Date())
    middlewareDispatch(getEmptyDispatch())(
      .participantsAction(.readReceiptReceived(readReceiptInfo: readReceiptInfo)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_repositoryMiddleware_apply_when_chatMessageLocalUserRemovedAction_then_addLocalUserRemovedMessageBeingCalled()
  {
    let middlewareDispatch = getEmptyChatMiddlewareFunction()
...
extension RepositoryMiddlewareTests {
  ...
  private func getEmptyStateWithLocalUser() -> ChatAppState {
    let chatState = ChatState(
      localUser: ParticipantInfoModel(identifier: CommunicationUserIdentifier(""), displayName: ""))
  ...
  private func getEmptyChatMiddlewareFunctionWithLocalUser() -> (@escaping ActionDispatch) ->
    ActionDispatch
  {
    return mockMiddleware.apply(getEmptyDispatch(), getEmptyStateWithLocalUser)
  }

  private func getAssertSameActionDispatch(action: Action, expectation: XCTestExpectation)
    -> ActionDispatch
  {
