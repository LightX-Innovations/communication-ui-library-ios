...
class RepositoryMiddlewareHandlerTests: XCTestCase {
  ...
  func
    test_repositoryMiddlewareHandler_updateSentMessageIdAndSendStatus_then_replaceMessageIdCalled()
    async
  {
  ...
  func
    test_repositoryMiddlewareHandler_updateEditedMessageTimestamp_then_updateEditMessageTimestampCalled()
    async
  {
  ...
  func
    test_repositoryMiddlewareHandler_updateDeletedMessageTimestamp_then_updateDeletedMessageTimestampCalled()
    async
  {
  ...
  func test_repositoryMiddlewareHandler_addTopicUpdatedMessage_then_addTopicUpdatedMessageCalled()
    async
  {
  ...
  func test_repositoryMiddlewareHandler_participantAddedMessage_then_participantAddedMessageCalled()
    async
  {
    let addParticipant = [
      ParticipantInfoModel(
        identifier: UnknownIdentifier("SomeUnknownIdentifier"),
        displayName: "MockBot")
    ]
    await repositoryMiddlewareHandler.participantAddedMessage(
  ...
  func
    test_repositoryMiddlewareHandler_participantRemovedMessage_then_participantRemovedMessageCalled()
    async
  {
    ...
    await repositoryMiddlewareHandler.participantRemovedMessage(
      participants: removedParticipant,
      dispatch: getEmptyDispatch()
    ).value
    let lastMessage = mockMessageRepositoryManager.messages.last
  ...
  func
    test_repositoryMiddlewareHandler_localParticipantRemoved_then_chatMessageLocalUserRemovedCalled()
    async
  {
    let removedParticipant = ParticipantInfoModel(
      identifier: UnknownIdentifier("SomeUnknownIdentifier"),
      displayName: "MockBot")
    await repositoryMiddlewareHandler.participantRemovedMessage(
      participants: [removedParticipant],
  ...
  func
    test_repositoryMiddlewareHandler_localParticipantRemoved_then_chatMessageLocalUserRemovedNotCalled()
    async
  {
    let removedParticipant = ParticipantInfoModel(
      identifier: UnknownIdentifier("SomeUnknownIdentifier"),
  ...
  func test_repositoryMiddlewareHandler_updateReceivedEditedMessage_then_updateMessageEditedCalled()
    async
  {
    let message = ChatMessageInfoModel()
  ...
  func
    test_repositoryMiddlewareHandler_updateReceivedDeletedMessage_then_updateMessageDeletedCalled()
    async
  {
    let message = ChatMessageInfoModel()
  ...
  func
    test_repositoryMiddlewareHandler_updateMessageReceiptReceivedStatus_then_updateMessageReceiptReceivedStatusCalled()
    async
  {
  ...
  func
    test_repositoryMiddlewareHandler_addLocalUserRemovedMessage_then_addLocalUserRemovedMessageCalled()
    async
  {
    let message = ChatMessageInfoModel()
    await repositoryMiddlewareHandler.addLocalUserRemovedMessage(
      state: getEmptyState(),
      dispatch: getEmptyDispatch()
    ).value
  ...
  func test_repositoryMiddlewareHandler_updateMessageSendStatus_then_updateMessageSendStatusCalled()
    async
  {
  ...
  func
    test_repositoryMiddlewareHandler_updateMessageReceiptReceivedStatus_then_updateMessageReadReceiptStatusCalled()
    async
  {
    let readReceiptInfo = ReadReceiptInfoModel(
      senderIdentifier: CommunicationUserIdentifier("Identifier"),
