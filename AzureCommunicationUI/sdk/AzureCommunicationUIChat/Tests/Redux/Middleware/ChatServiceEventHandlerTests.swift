...
class ChatServiceEventHandlerTests: XCTestCase {
  ...
  override func setUp() {
    ...
    chatServiceEventHandler = ChatServiceEventHandler(
      chatService: mockChatService, logger: mockLogger)
  }
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveRealTimeNotificationConnectedEvent_then_dispatchRealTimeNotificationConnectedAction()
  {
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveRealTimeNotificationDisonnectedEvent_then_dispatchRealTimeNotificationDisonnectedAction()
  {
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    func dispatch(action: Action) {
      switch action {
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveChatMessageReceivedEvent_then_dispatchChatMessageReceivedAction()
  {
    let expectation = XCTestExpectation(description: "Dispatch the new action")
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveChatMessageEditedEvent_then_dispatchChatMessageEditedReceivedAction()
  {
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    let expectedMessageId = "messageId"
    func dispatch(action: Action) {
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveChatMessageDeletedEvent_then_dispatchChatMessageDeletedReceivedAction()
  {
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    let expectedMessageId = "messageId"
    func dispatch(action: Action) {
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveTypingIndicatorReceivedEvent_then_dispatchTypingIndicatorReceivedAction()
  {
    ...
    let chatMessageReceivedEvent = ChatEventModel(
      ...
      infoModel: UserEventTimestampModel(
        userIdentifier: CommunicationUserIdentifier("identifier"),
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveReadReceiptReceivedEvent_then_dispatchReadReceiptReceivedAction()
  {
    ...
    let chatMessageReceivedEvent = ChatEventModel(
      ...
      infoModel: ReadReceiptInfoModel(
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveChatThreadDeletedEvent_then_dispatchChatThreadDeletedAction()
  {
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    func dispatch(action: Action) {
      switch action {
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveChatThreadPropertiesUpdatedEvent_then_dispatchChatTopicUpdatedAction()
  {
    let expectation = XCTestExpectation(description: "Dispatch the new action")
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveParticipantsAddedEvent_then_dispatchParticipantsAddedAction()
  {
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    let expectedUserId = "identifier"
    ...
    let chatEventModel = ChatEventModel(
      ...
      infoModel: ParticipantsInfoModel(
  ...
  func
    test_chatServiceEventHandler_subscription_when_receiveParticipantsRemovedEvent_then_dispatchParticipantsRemovedAction()
  {
    let expectation = XCTestExpectation(description: "Dispatch the new action")
    let expectedUserId = "identifier"
    let localUserId = "local"
