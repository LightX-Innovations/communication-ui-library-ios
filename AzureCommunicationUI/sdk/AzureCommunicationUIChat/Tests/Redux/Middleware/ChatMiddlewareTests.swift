...
class ChatMiddlewareTests: XCTestCase {
  ...
  func
    test_chatMiddleware_apply_when_initializeChatTriggeredChatAction_then_handlerInitializeBeingCalled()
  {
  ...
  func
    test_chatMiddleware_apply_when_chatThreadDeletedChatAction_then_handlerNnChatThreadDeletedCalledCalled()
  {
  ...
  func
    test_chatMiddleware_apply_when_fetchInitialMessagesTriggeredRepositoryAction_then_handlerGetInitialMessagesBeingCalled()
  {
  ...
  func
    test_chatMiddleware_apply_when_fetchInitialMessagesTriggeredRepositoryAction_then_handlerGetListOfParticipantsBeingCalled()
  {
  ...
  func
    test_chatMiddleware_apply_when_sendMessageTriggeredRepositoryAction_then_handlerGetPreviousMessagesBeingCalled()
  {
  ...
  func
    test_chatMiddleware_apply_when_sendMessageTriggeredRepositoryAction_then_handlerSendMessageCalledBeingCalled()
  {
    ...
    middlewareDispatch(getEmptyDispatch())(
      .repositoryAction(.sendMessageTriggered(internalId: "internalId", content: "content")))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_chatMiddleware_apply_when_editMessageTriggeredRepositoryAction_then_handlerEditMessageCalledBeingCalled()
  {
    ...
    middlewareDispatch(getEmptyDispatch())(
      .repositoryAction(
        .editMessageTriggered(
          messageId: "messageId", content: "content", prevContent: "prevContent")))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_chatMiddleware_apply_when_deleteMessageTriggeredRepositoryAction_then_handlerEditMessageCalledBeingCalled()
  {
    ...
    middlewareDispatch(getEmptyDispatch())(
      .repositoryAction(.deleteMessageTriggered(messageId: "messageId")))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_chatMiddleware_apply_when_sendTypingIndicatorTriggered_then_handlerSendTypingIndicatorCalled()
  {
    let middlewareDispatch = getEmptyChatMiddlewareFunction()
  ...
  func
    test_chatMiddleware_apply_when_recieveTypingIndicatorTriggered_then_handlerSetTypingIndicatorTimeoutCalled()
  {
    let middlewareDispatch = getEmptyChatMiddlewareFunction()
    ...
    middlewareDispatch(getEmptyDispatch())(
      .participantsAction(.typingIndicatorReceived(participant: model)))
    wait(for: [expectation], timeout: 1)
  }

  func
    test_chatMiddleware_apply_when_sendReadReceiptTriggered_then_handlerSendReadReceiptCalledBeingCalled()
  {
    let middlewareDispatch = getEmptyChatMiddlewareFunction()
    ...
    middlewareDispatch(getEmptyDispatch())(
      .participantsAction(.sendReadReceiptTriggered(messageId: "messageId")))
    wait(for: [expectation], timeout: 1)
  }
}
