...
class ChatServiceEventHandler: ChatServiceEventHandling {
    ...
    chatService.chatEventSubject
      .sink { [weak self] chatEvent in
        ...
        case (
          ...
          self.handleTypingIndicatorReceived(
            dispatch: dispatch, userEventTimestamp: userEventTimestamp)
        case (
          .readReceiptReceived,
  ...
  func handleChatMessageReceived(
  ...
  func handleTypingIndicatorReceived(
    dispatch: @escaping ActionDispatch,
  ...
  func handleReadReceiptReceived(
    dispatch: @escaping ActionDispatch,
  ...
  func handleChatThreadPropertiesUpdated(
    dispatch: @escaping ActionDispatch,
    threadInfo: ChatThreadInfoModel
  ) {
  ...
  func handleParticipantsRemoved(
    dispatch: @escaping ActionDispatch,
    participantsInfo: ParticipantsInfoModel
  ) {
