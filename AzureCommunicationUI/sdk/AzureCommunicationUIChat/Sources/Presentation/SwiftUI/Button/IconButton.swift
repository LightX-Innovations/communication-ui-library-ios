...
struct IconButton: View {
  ...
  var body: some View {
    ...
    Group {
      ...
      .foregroundColor(
        viewModel.isDisabled ? buttonDisabledColor : buttonType.buttonForegroundColor
      )
      .frame(width: buttonType.width, height: buttonType.height, alignment: .center)
      .background(buttonType.buttonBackgroundColor)
      .clipShape(
        RoundedCornersShape(
          radius: buttonType.shapeCornerRadius, corners: buttonType.roundedCorners)
      )
    ...
    .frame(
      width: buttonType.tappableWidth,
