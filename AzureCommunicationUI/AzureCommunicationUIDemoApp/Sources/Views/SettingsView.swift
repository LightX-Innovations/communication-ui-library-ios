...
struct SettingsView: View {
  ...
  var mockCallingSDKToggle: some View {
    Toggle(
      "Use mock Calling SDK Wrapper Handler",
  ...
  var relaunchCompositeOnDismissedToggle: some View {
    Toggle(
      "Relaunch composite after dismiss api call",
      isOn: $envConfigSubject.useRelaunchOnDismissedToggle
    )
    .accessibilityIdentifier(
      AccessibilityId.useRelaunchOnDismissedToggleToggleAccessibilityID.rawValue)
  }
